-- Migrazione SQL semplificata per Supabase
-- Esegui un comando alla volta per evitare errori

-- STEP 1: Crea tabella projects
...
-- STEP 2: Crea tabella properties
...
-- STEP 4: Inserisci dati projects
INSERT INTO projects (titolo, descrizione, categoria, immagini, data, dettagli) VALUES
(
    'Attico Prisma',
    'Progetto di ristrutturazione completa di un attico con vista panoramica. Design moderno con materiali sostenibili e massima illuminazione naturale.',
    'residenziale',
    '["attico1.jpg", "attico2.jpg"]',
    '2024-01-15',
    '{"superficie": "180mq", "localita": "Milano", "durata": "6 mesi", "budget": "150.000"}'
)
...
(
    'Villa Orizzonte',
    'Nuova costruzione villa moderna con giardino paesaggistico. Architettura integrata con il paesaggio circostante.',
    'residenziale',
    '["villa1.jpg", "villa2.jpg"]',
    '2024-02-20',
    '{"superficie": "320mq", "localita": "Como", "durata": "12 mesi", "budget": "450.000"}'
)
ON CONFLICT DO NOTHING;

-- STEP 5: Inserisci dati properties
INSERT INTO properties (titolo, descrizione, prezzo, localita, superficie, camere, immagini) VALUES
(
    'Villa Orizzonte',
    'Esclusiva villa moderna con piscina infinity',
    '850.000',
    'Como',
    '320',
    4,
...
-- STEP 6: Inserisci dati articles
INSERT INTO articles (titolo, descrizione, contenuto, data, categoria) VALUES
(
    'Tendenze architettura 2024',
    'Le nuove tendenze nel design architettonico per il nuovo anno',
    'Articolo completo sulle tendenze dell''architettura moderna per il 2024, con focus su sostenibilità, materiali innovativi e design biophilic.',
    '2024-03-10',
    'design'
)
ON CONFLICT DO NOTHING;
...
-- STEP 9: Crea policy lettura pubblica
...
-- STEP 10: Crea policy per utenti autenticati
...
-- STEP 11: Crea funzione per timestamp
