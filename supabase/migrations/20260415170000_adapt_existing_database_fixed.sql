-- Adatta database esistente con tabella clienti - VERSIONE CORRETTA
...
-- ========================================
-- 3. CREAZIONE TABELLE MANCANTI - ORDINE CORRETTO PER DIPENDENZE
-- ========================================

-- Prima creiamo le tabelle senza dipendenze esterne
-- Folders table (prima perché documents la reference)
...
-- Documents table (ora può reference folders)
...
BEGIN
    ...
    RAISE NOTICE 'Tabelle create: folders, projects, documents, messages, activities, tasks, notifications, permissions';
