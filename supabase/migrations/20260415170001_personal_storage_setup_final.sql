-- Storage Setup for Personal Files - Home Design Lab - VERSIONE FINALE DEFINITIVA
...
-- ========================================
-- 3. STORAGE FUNCTIONS FOR PERSONAL FILES (CORRETTE)
-- ========================================
...
-- ========================================
-- 6. STORAGE VIEWS FOR EASY ACCESS (CORRETTE)
-- ========================================
...
SELECT 
    ...
    COALESCE(AVG((metadata->>'size')::BIGINT), 0) as avg_size,
