-- Migrazione per creare tabelle dati principali
-- Sposta i dati hardcoded da app.py al database Supabase
-- Versione corretta e testata
...
-- Policy per insert/update solo per utenti autenticati
