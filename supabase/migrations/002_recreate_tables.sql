-- Script per cancellare e ricreare le tabelle
-- Esegui questo script per ripartire da zero

-- STEP 1: Cancella le tabelle esistenti (in ordine inverso per evitare foreign key issues)
DROP TABLE IF EXISTS articles CASCADE;
DROP TABLE IF EXISTS properties CASCADE;
DROP TABLE IF EXISTS projects CASCADE;

-- STEP 2: Ricrea tabella projects
...
-- STEP 3: Ricrea tabella properties
...
-- STEP 4: Ricrea tabella articles
...
-- STEP 5: Inserisci dati projects
...
-- STEP 6: Inserisci dati properties
...
-- STEP 7: Inserisci dati articles
...
CREATE INDEX idx_projects_stato ON projects(stato);
CREATE INDEX idx_properties_stato ON properties(stato);
CREATE INDEX idx_properties_localita ON properties(localita);
CREATE INDEX idx_articles_categoria ON articles(categoria);
CREATE INDEX idx_articles_stato ON articles(stato);
