$file = "c:\Users\Gianni\OneDrive\Desktop\Sito\Home Design Lab rev2\gestione-journal.html"
...
$content = $content -replace "defaultActiveMenu: 'overview'", "defaultActiveMenu: 'journal'"
Set-Content $file $content -NoNewline
Write-Host "gestione-journal.html done"
